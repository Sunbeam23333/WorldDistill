...
if __name__ == "__main__":
    ...
    checkpoint_path = os.environ["LTX2_CHECKPOINT"]
    ...
    vid_enc = torch.load(os.environ["LTX2_VIDEO_LATENT"]).unsqueeze(0)
    vid_dec = video_vae.decode(vid_enc)

    audio_enc = torch.load(os.environ["LTX2_AUDIO_LATENT"]).unsqueeze(0)
